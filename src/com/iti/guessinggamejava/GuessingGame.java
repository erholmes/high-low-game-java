...
public class GuessingGame extends Activity{
	...
	int [] photos={R.drawable.a0, R.drawable.a1, R.drawable.a2, R.drawable.a3,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//ImageView randomFrontView = (ImageView) findViewById(R.id.randomFrontView);
	    //randomFrontView.setImageResource(R.drawable.front);
	    //ObjectAnimator anim = (ObjectAnimator) AnimatorInflater.loadAnimator(getApplicationContext(), R.animator.translateanimation);
	    //anim.setTarget(randomFrontView);
	    //anim.setDuration(400);
	    //anim.start();
		
		ImageView randomFrontView = (ImageView) findViewById(R.id.randomFrontView2);
	    randomFrontView.setImageResource(R.drawable.front);
	    ObjectAnimator anim = ObjectAnimator.ofFloat(randomFrontView, "translationY", -500, 0);
	    anim.setDuration(400);
	    anim.start();
	    
	    ImageView randomView = (ImageView) findViewById(R.id.randomView);
	    randomView.setImageResource(photos[numberToGuess]);  
	    ObjectAnimator anim1 = ObjectAnimator.ofFloat(randomView, "translationX", 0, -440);
